// ============================================================
// TelaHome.kt - Tela inicial e tela Sobre do app Zelus
// Exibe opcoes de nova denuncia, ver denuncias e sobre o app
// ============================================================
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Surface(shape = RoundedCornerShape(topStart = 60.dp, topEnd = 60.dp), color = Color.White, modifier = Modifier.fillMaxWidth().weight(1f)) {
            Column(
                ...
                BotaoZelus(texto = "Nova Denuncia", icone = Icons.Default.Notifications, onClick = onNovaDenunciaClick)
                BotaoZelus(texto = "Ver Denuncias", icone = Icons.AutoMirrored.Filled.List, onClick = onVerDenunciasClick)
    ...
    Column(
        ...
        Surface(shape = RoundedCornerShape(24.dp), color = Color(0xFFD6F5DA), modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(24.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                Text(text = "O Zelus Ã© um aplicativo criado para ajudar cidadãos a denunciar problemas urbanos de forma rápida e simples.", fontSize = 15.sp, color = Color.DarkGray)
                Spacer(modifier = Modifier.height(16.dp))

                val topicos = listOf(
                    "Facilitar o registro de problemas urbanos na cidade,",
                    "Permitir que cidadçãos enviem denuncias com foto e localização,",
                    "Ajudar na identificação rápida de problemas nas ruas,",
                    "Melhorar a comunicação entre moradores e orgãos resposáveis e",
